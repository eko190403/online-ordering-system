...
<html>
<head>
    <title>Print Order - {{ $order->order_code }}</title>
    <style>
    ...
    <div class="receipt">
        ...
        <div class="items">
            ...
            @foreach($order->items as $item)
                <div class="item">
                    <div class="item-header">{{ $item->menu->name }}</div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px; font-size: 10px;">Struk ini dicetak pada {{ now()->format('d/m/Y H:i:s') }}</p>
        </div>
    </div>
