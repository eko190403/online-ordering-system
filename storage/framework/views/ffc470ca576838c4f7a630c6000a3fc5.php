...
<div class="container py-4">
    <div class="text-center mb-5">
        ...
        <small class="text-muted">
            <i class="fas fa-clock"></i> Buka: <?php echo e($openTime ?? '08:00'); ?> - <?php echo e($closeTime ?? '22:00'); ?>
    ...
    <div class="alert alert-warning alert-dismissible fade show text-center mb-4" role="alert">
        ...
        <p class="mb-0">Jam operasional: <strong><?php echo e($openTime); ?> - <?php echo e($closeTime); ?></strong></p>
    ...
    <div class="mb-4">
        <form method="GET" action="<?php echo e(route('menu.index')); ?>">
            <div class="input-group input-group-lg shadow-sm">
                ...
                <a href="<?php echo e(route('menu.index')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="mb-5">
        <div class="d-flex gap-2 flex-wrap justify-content-center">
            <a href="<?php echo e(route('menu.index')); ?>" class="btn btn-category btn-outline-dark rounded-pill px-4">
                <i class="fas fa-th"></i> Semua Menu
            </a>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('menu.category', $cat->id)); ?>" class="btn btn-category btn-outline-dark rounded-pill px-4">
                    <i class="fas fa-utensils"></i> <?php echo e($cat->name); ?>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-card-hover h-100 border-0 shadow-sm <?php echo e($isOutOfStock ? 'opacity-50' : ''); ?>" 
                    ...
                    <div class="menu-detail position-relative overflow-hidden" 
                         ...
                         data-menu-description="<?php echo e($menu->description); ?>"
                         data-menu-price="<?php echo e($menu->price); ?>"
                         data-menu-photo="<?php echo e($menu->photo); ?>"
                         data-menu-category="<?php echo e($menu->category->name); ?>"
                         data-is-out="<?php echo e($isOutOfStock ? '1' : '0'); ?>">
                        <?php if($menu->photo): ?>
                        ...
                        <div class="position-absolute top-0 start-0 m-2">
                            <span class="badge bg-dark bg-opacity-75">
                                <i class="fas fa-tag"></i> <?php echo e($menu->category->name); ?>
                    ...
                    <div class="card-body p-3">
                        <h6 class="card-title mb-2 fw-bold"><?php echo e($menu->name); ?></h6>
                        <p class="card-text small text-muted mb-3" style="min-height: 40px;"><?php echo e(Str::limit($menu->description, 60)); ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 text-primary fw-bold">Rp <?php echo e(number_format($menu->price, 0, ',', '.')); ?></h5>
                            <?php if(!$isOutOfStock): ?>
...
$('#checkoutBtn').on('click', function() {
    ...
    Swal.fire({
        icon: 'error',
        title: 'Cafe Tutup',
        text: 'Maaf, cafe sedang tutup. Silakan pesan pada jam operasional (<?php echo e($openTime); ?> - <?php echo e($closeTime); ?>)'
    });
    return;
    <?php endif; ?>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            // Set tracking link
            const trackUrl = '<?php echo e(url("/track")); ?>/' + response.order_code;
...
function showTrackingButton() {
    ...
    if (activeOrder) {
        ...
        const trackUrl = '<?php echo e(url("/track")); ?>/' + order.order_code;
...
$(document).ready(function() {
    ...
    setInterval(function() {
        ...
        if (activeOrder) {
            ...
            $.ajax({
                url: '<?php echo e(url("/api/check-order-status")); ?>/' + order.order_code,
                method: 'GET',
                success: function(response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cafe\resources\views/menu/index.blade.php ENDPATH**/ ?>