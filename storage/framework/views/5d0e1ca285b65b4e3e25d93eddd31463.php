...
<div class="mb-5">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="bg-white px-4 py-2 rounded-pill shadow-sm text-muted fw-medium">
            <i class="fas fa-calendar-alt text-primary me-2"></i> <?php echo e(date('d F Y')); ?>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark"><?php echo e($totalOrders); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark"><?php echo e($ordersMasuk); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark"><?php echo e($ordersDiproses); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark"><?php echo e($ordersSelesai); ?></h2>
                    </div>
    ...
    <div class="col-md-6">
        <div class="card border-0" style="background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: white;">
            <div class="card-body p-4 position-relative overflow-hidden">
                ...
                <h1 class="display-5 fw-bold mb-1">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h1>
    ...
    <div class="col-md-6">
        <div class="card border-0" style="background: linear-gradient(135deg, #2563eb 0%, #3b82f6 100%); color: white;">
            <div class="card-body p-4 position-relative overflow-hidden">
                ...
                <h1 class="display-5 fw-bold mb-1">Rp <?php echo e(number_format($todayRevenue, 0, ',', '.')); ?></h1>
                <p class="mb-0 text-white-50">Pendapatan pada <?php echo e(date('d F Y')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-6">
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php if($topMenus->count() > 0): ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $topMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center me-3 shadow-sm bg-white" style="width: 40px; height: 40px; border: 1px solid #f1f5f9;">
                                        <span class="fw-bold text-secondary"><?php echo e($index + 1); ?></span>
                                    </div>
                                    <div>
                                        <h6 class="mb-0 fw-bold"><?php echo e($item->menu->name ?? 'N/A'); ?></h6>
                                        <small class="text-muted"><?php echo e($item->menu->category->name ?? ''); ?></small>
                                    </div>
                                </div>
                                <span class="badge badge-soft-primary px-3 py-2 rounded-pill fs-6"><?php echo e($item->total_qty); ?> terjual</span>
                            </div>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php if($peakHours->count() > 0): ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $peakHours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $peak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0 fw-bold"><?php echo e(sprintf('%02d:00', $peak->hour)); ?> - <?php echo e(sprintf('%02d:00', $peak->hour + 1)); ?></h6>
                                </div>
                                <span class="badge badge-soft-warning px-3 py-2 rounded-pill fs-6"><?php echo e($peak->count); ?> orders</span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark"><?php echo e($totalMenus); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark"><?php echo e($totalCategories); ?></h2>
                    </div>
                    <div class="rounded-circle d-flex align-items-center justify-content-center border" style="width: 56px; height: 56px; color: #475569;">
...
<script>
// Revenue Trend Chart
const trendData = <?php echo json_encode($revenueTrend, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cafe\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>